...
public class FunSDKLoginModule extends ReactContextBaseJavaModule {
  ...
  /* Log in locally. After logging in locally, the added device will be saved in the private app directory of the mobile phone. */
  @ReactMethod
  public void loginByLocal(Promise promise) {
    // TODO
    // String dbPath = PathUtils.getAndroidPath(/* add here */) + File.separator + "CSFile.db";
